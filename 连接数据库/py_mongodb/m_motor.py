...
# 普通连接
client = motor.motor_asyncio.AsyncIOMotorClient('mongodb://localhsot:27017')
# 副本集连接
client = motor.motor_asyncio.AsyncIOMotorClient('mongodb:host1,host2/?replocaSet=my-replicaset-name')
# 密码连接
